/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 71eee7d1421ca4e8ef8be789cf422b0c)
// Runtime types generated with workerd@1.20260526.1 2025-05-26 
interface __BaseEnv_Env {
	EVENTS: KVNamespace;
	DEPLOYMENT_SESSION: DurableObjectNamespace<import("./src/index").DeploymentSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeploymentSession";
	}
