...
_SPECS: list[MCPServerSpec] = [
    MCPServerSpec(
        ...
        setup_steps=(
            ...
            "Paste it below — bobi wires Stripe's hosted MCP into the team "
    ...
    MCPServerSpec(
        ...
        setup_steps=(
            ...
            "Paste it below — bobi wires the Hugging Face hosted MCP in.",
        ),
    ),
    MCPServerSpec(
    ...
    MCPServerSpec(
        ...
        oauth_note="Public hosted MCP — no key required. bobi wires it in.",
    ),
]
