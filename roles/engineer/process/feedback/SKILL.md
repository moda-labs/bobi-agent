...
commit/push conventions, `practices/code-review` for mandatory review of fixes.
...
`practices/code-review` — invoke `/investigate` for root cause.
...
Follow mandatory review in `practices/code-review`. Give `/review` just
