...
(() => {
  ...
  const DOCS_CLOUD_URL = "https://github.com/moda-labs/modastack/blob/main/docs/CONTAINER.md";
    ...
    $("#main").innerHTML = `<main class="done-wrap">
      ...
      <div class="deploy">
        ...
        <div class="deploy-opt">
          ...
          <div class="cmd"><span class="pr">$</span> <span class="cmd-text">scripts/provision-instance.sh --app you-modastack --team ${esc(slugify(S.team_name) || "your-team")} --env-file ./instance.env</span>
