...
application can act. This module is that missing layer: ``modastack supervise``
...
class Supervisor:
    ...
    def _default_spawn(self):
        cmd = [sys.executable, "-m", "modastack.cli", "start", *self.start_args]
    ...
    def _announce(self, message: str) -> None:
        ...
        if self._announce_fn is not None:
            ...
            return
        token = (os.environ.get("MODASTACK_SLACK_BOT_TOKEN")
