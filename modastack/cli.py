...
def agent(repo, workflow, role, task, timeout, wait, post_event, requested_by, non_interactive, issue):
...
def spawn(repo, task, timeout, non_interactive, post_event, requested_by):
    ...
    _dispatch_agent(repo=repo, task=task, workflow="adhoc", role="engineer",
                    timeout=timeout, wait=non_interactive, post_event=post_event,
                    requested_by=requested_by)


def _dispatch_agent(*, repo, task, workflow, role, timeout, wait, post_event, requested_by, interactive=True, issue_id=None):
