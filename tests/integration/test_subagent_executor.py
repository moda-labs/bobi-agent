...
class TestSessionNaming:
    ...
    def test_default_prefix(self):
        from bobi.subagent import _session_name
...
class TestLifecycleEvents:
    ...
    def test_emit_calls_post_event(self, bobi_env):
        from bobi.subagent import _emit_lifecycle_event

        with patch("bobi.events.publish.post_event") as mock_post:
    ...
    def test_summarize_output(self):
        from bobi.subagent import _summarize_output
