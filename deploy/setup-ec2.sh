...
echo ""
echo "  4. Register repos:"
echo "     source ~/modastack/.venv/bin/activate"
echo "     modastack setup ~/your-repo --linear-project PROJ --linear-key lin_api_..."
echo ""
echo "  5. Update webhooks to point to this machine:"
echo "     EC2_URL=http://\$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):8080"
echo "     echo \"Webhook URL: \$EC2_URL\""
echo "     # Update GitHub + Linear webhooks to use this URL"
echo ""
echo "  6. Start modastack:"
